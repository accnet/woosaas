...
export default function CustomersPage() {
  ...
  return (
    <div className="space-y-8">
      <AnalyticsPageHeader
        title="Customer 360"
        description="Browse customer profiles, search by identity, and drill from summary signals into recent behavior."
        controls={
          <>
      ...
      <TableSection
        ...
        description="Search by email or client id, then pivot into profile detail, orders, and event timeline."
        action={
