CREATE TABLE IF NOT EXISTS woo_order_contacts (
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_woo_order_contacts_site_email
    ON woo_order_contacts (site_id, email)
    WHERE email IS NOT NULL AND email <> '';
CREATE INDEX IF NOT EXISTS idx_woo_order_contacts_site_phone
    ON woo_order_contacts (site_id, phone);
CREATE INDEX IF NOT EXISTS idx_woo_order_contacts_site_customer
    ON woo_order_contacts (site_id, woo_customer_id);
...
CREATE TABLE IF NOT EXISTS woo_orders (
    ...
    contact_id UUID REFERENCES woo_order_contacts(id) ON DELETE SET NULL,
...
CREATE INDEX IF NOT EXISTS idx_woo_orders_site_created_at_woo
    ON woo_orders (site_id, created_at_woo DESC);
CREATE INDEX IF NOT EXISTS idx_woo_orders_site_modified_at_woo
    ON woo_orders (site_id, modified_at_woo DESC);
CREATE INDEX IF NOT EXISTS idx_woo_orders_site_contact_id
    ON woo_orders (site_id, contact_id);
CREATE INDEX IF NOT EXISTS idx_woo_orders_site_status
    ON woo_orders (site_id, status);
...
CREATE INDEX IF NOT EXISTS idx_woo_order_items_site_product
    ON woo_order_items (site_id, product_id);

CREATE TABLE IF NOT EXISTS woo_order_sync_state (
